  ...
  return (
    <div className='text-gray-900'>
      ...
      <div className="relative h-screen flex flex-col justify-center items-center text-5xl font-bold overflow-hidden"> {/* Added overflow-hidden */}
        ...
        {/* Text Content */}
        <h1 className="relative z-10 text-[clamp(2rem,5vw,5rem)] font-bold mt-14 mb-8 text-center px-4"> {/* Added relative z-10 and centering/padding */}
          <span
            className="text-[#FF9A02] cursor-pointer mr-2 md:mr-5" // Adjusted margin
        ...
        <p className="relative z-10 text-[clamp(2rem,5vw,5rem)] font-bold mb-8 text-center px-4"> {/* Added relative z-10 and centering/padding */}
          don't have to{" "}
          <span
